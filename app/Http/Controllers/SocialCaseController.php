...
class SocialCaseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'family_members_count' => 'nullable|integer|min:0|max:20',
            ...
            'family_members.*.gender' => 'required_with:family_members|in:male,female',
            'family_members.*.status' => 'required_with:family_members|in:healthy,sick,disabled,deceased,unknown',
