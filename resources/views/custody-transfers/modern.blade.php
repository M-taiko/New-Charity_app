            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <p class="text-muted small mb-1">إجمالي التحويلات</p>
                                <h4 class="mb-0" style="color: #10b981;">{{ $totalTransfersCount }}</h4>
                            </div>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <p class="text-muted small mb-1">مقبولة</p>
                                <h4 class="mb-0" style="color: #667eea;">{{ $approvedTransfersCount }}</h4>
                            </div>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <p class="text-muted small mb-1">مرفوضة</p>
                                <h4 class="mb-0" style="color: #ef4444;">{{ $rejectedTransfersCount }}</h4>
                            </div>
    ...
    <div class="row" data-aos="fade-up" data-aos-delay="100">
        <div class="col-12">
                ...
                @if($isMgmt)
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="all-tab" data-bs-toggle="tab" data-bs-target="#all" type="button" role="tab" aria-controls="all" aria-selected="true">
                            <i class="fas fa-globe"></i> كل التحويلات
                        </button>
                    </li>
                @endif
                <li class="nav-item" role="presentation">
                    <button class="nav-link {{ $isMgmt ? '' : 'active' }}" id="sent-tab" data-bs-toggle="tab" data-bs-target="#sent" type="button" role="tab" aria-controls="sent" aria-selected="{{ $isMgmt ? 'false' : 'true' }}">
            ...
            <div class="tab-content" id="transferTabContent" style="padding: 20px; border: 1px solid #e0e7ff; border-top: none;">
                @if($isMgmt)
                    <!-- All Transfers Tab (management) -->
                    <div class="tab-pane fade show {{ $isMgmt ? 'active' : '' }}" id="all" role="tabpanel" aria-labelledby="all-tab">
                        <div class="table-responsive">
                            <table id="allTransfersTable" class="table table-hover">
                                <thead>
                ...
                <!-- Sent Transfers Tab -->
                <div class="tab-pane fade show {{ $isMgmt ? '' : 'active' }}" id="sent" role="tabpanel" aria-labelledby="sent-tab">
                    <div class="table-responsive">
...
<script>
    $(document).ready(function() {
        ...
        // All transfers table (management)
        if ($('#allTransfersTable').length) {
            $('#allTransfersTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route("api.custody-transfers.all") }}',
                columns: [
