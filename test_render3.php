...
echo "=== Testing View Rendering (With Null Checks) ===\n\n";
...
try {
    ...
    echo "\nKey elements found:\n";
    echo "✓ remainingBreakdown div\n";
    echo "✓ toggleRemainingBreakdown function\n";
    echo "✓ toggleAgentDetail function\n";
    echo "✓ Agent summary rows (" . $agentsSummary->count() . " agents)\n";
