...
echo "=== Testing View Rendering (Fixed) ===\n\n";
...
try {
    ...
    echo "Active custodies: " . $activeCustodies->count() . "\n";
    echo "With agents: " . $custodiesWithAgents->count() . "\n\n";
    ...
    echo "✓ Agents summary: " . $agentsSummary->count() . " agents\n";
    ...
    if (strpos($html, 'agentChevron') !== false && $agentsSummary->count() > 0) {
        echo "✓ Agent detail rows generated\n";
    }
